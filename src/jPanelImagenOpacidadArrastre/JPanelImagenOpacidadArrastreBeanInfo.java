 ...
 * @author profesor
 */
public class JPanelImagenOpacidadArrastreBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_imagenFondo] = new PropertyDescriptor ( "imagenFondo", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getImagenFondo", "setImagenFondo" ); // NOI18N
            properties[PROPERTY_imagenFondo].setPropertyEditorClass ( jPanelImagenOpacidadArrastre.ImagenFondoPropertyEditorSupport.class );
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mixingCutoutShape] = new PropertyDescriptor ( "mixingCutoutShape", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, null, "setMixingCutoutShape" ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getParent", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_addArrastreListener7 = 7;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_addArrastreListener7] = new MethodDescriptor(jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class.getMethod("addArrastreListener", new Class[] {jPanelImagenOpacidadArrastre.ArrastreListener.class})); // NOI18N
            methods[METHOD_addArrastreListener7].setDisplayName ( "" );
            ...
            methods[METHOD_removeArrastreListener112] = new MethodDescriptor(jPanelImagenOpacidadArrastre.JPanelImagenOpacidadArrastre.class.getMethod("removeArrastreListener", new Class[] {jPanelImagenOpacidadArrastre.ArrastreListener.class})); // NOI18N
